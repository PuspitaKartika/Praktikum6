                                  ...
                                  child: PopupMenuButton<String>(
                                    onSelected: (value) {
                                      if (value == 'edit') {
                                                                        ...
                                                                        if (_formKey
                                                                          ...
                                                                          try {
                                                                            ...
                                                                            ScaffoldMessenger.of(context).showSnackBar(
                                                                              const SnackBar(content: Text('Note berhasil diperharui')),
                                                                            );
                                                                            Navigator.pop(context);
                                                                          } catch (e) {
                                                                            ScaffoldMessenger.of(context).showSnackBar(
                                        ...
                                        // Tindakan yang diambil saat menu edit dipilih
                                        // Misalnya, navigasi ke halaman edit dengan mengirimkan ID dokumen
